...
`bootstrap_token_delta` and `paired_exact_cp` bound before truth. There is no
automatic CI or promotion gate and no extra inherited harm route.

The mandatory restore gate requires two verified durable copies, including the
proposed Windows backup boundary
/mnt/c/Users/alanz/Token-Reconstruction-Backups/TRR-0012, clean-workspace
retrieval, exact file/tensor identities, and a fixed already-opened public
smoke test. The smoke fixture is the first two already-opened TRR-0010
