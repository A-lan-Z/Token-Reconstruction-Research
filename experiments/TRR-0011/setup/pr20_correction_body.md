## Interpretation correction — TRR-0011 amendment

All **256/256** PR20 evaluation sources overlap checkpoint-selection validation: Pile 128/128 is the identical ordered TRR-0009 panel; Finance 128/128 is the first half of its 256-record validation panel. Record IDs, rendered-source hashes, and final-sequence hashes agree. These scores are **selection-overlapping development evidence, not independent text-generalization estimates**. The predictions, scores, selected states, and historical decision receipts remain unchanged. This does not allege answer access during inference or gradient fitting on the validation records.

[Exact metadata-only overlap report and correction](https://github.com/A-lan-Z/Token-Reconstruction-Research/blob/ed714466dfacdb434a68e20f7d0a4e2f4ea35007/coordination/results/TRR-0010-interpretation-correction.md). Independent frozen-model confirmation is assigned to TRR-P10; controlled transfer diagnostics are separate in TRR-0011.

---

The original result description follows as historical development evidence.
