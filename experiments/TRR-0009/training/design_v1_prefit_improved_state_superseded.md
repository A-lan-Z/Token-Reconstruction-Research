...
All three arms start from the same published TRR-0007 improved-bank
`trr0007_residual_mlp512` selected state:

- State: `/home/alanz/spartan/punim2939/Token-Reconstruction-Research/.worktrees/TRR-0007/experiments/TRR-0007/improved_fit_v1/improved_public_bank/trr0007_residual_mlp512/selected.safetensors`
- State SHA-256: `08056c5981343a5d3271a90cb564cf2f5cd143d5a117b11abfb5a38ea806c076`
- State metadata: selected step 2100 from a 3000-step fit; residual MLP512; current-H only; full-vocabulary CE.
...
seed 11012 and cap 2,048. The published improved-bank receipt for this exact
starting state reports 124,371/124,371 fit tokens correct, so the expected
selected-state challenge is empty; the trainer remeasures and records the
actual result, including any deviation, without substituting another mask. No
neutral-model challenge mask is substituted. The older TRR-0007 neutral masks
(`046cc...` and `b69af...`) are retained only as historical diagnostics and
are excluded from TRR-0009 selection or claims. An empty starting-state
challenge is reported as such; held-out validation and frequency-stratified
fit curves remain the informative comparisons.
