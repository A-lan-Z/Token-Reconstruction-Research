...
def main(argv: list[str] | None = None) -> int:
    ...
    command_record = {
        "schema": "token-reconstruction.trr-p03-resource-watchdog-command.v1",
        "task_id": TASK_ID,
    ...
    guard_receipt = {
        "schema": "token-reconstruction.trr-p03-resource-watchdog-guard.v1",
        "task_id": TASK_ID,
        "status": guard_status,
    ...
    time_receipt = {
        "schema": "token-reconstruction.trr-p03-resource-watchdog-time.v1",
        "task_id": TASK_ID,
        "status": guard_status,
    ...
    finish = {
        "schema": "token-reconstruction.trr-p03-resource-watchdog-finish.v1",
        "task_id": TASK_ID,
        "status": guard_status,
        "wrapper_exit_code": wrapper_exit,
        "child_return_code": child_returncode,
...
if __name__ == "__main__":
    try:
        ...
        print(f"TRR-P03 resource watchdog failed before launch: {exc}", file=sys.stderr)
